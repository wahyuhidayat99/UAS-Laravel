...
@section('body')
    <div class="d-flex align-items-center justify-content-between">
        <h1 class="mb-0">List Negara</h1>
        <a href="negara-add" class="btn btn-primary">Add</a>
    </div>
    <hr />
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <a href="negara-edit/{{$data->id}}" type="button" class="btn btn-warning">Edit</a>
                            <form action="/negara/{{$data->id}}" method="POST"  class="btn btn-danger p-0" >
                                @csrf
                                @method('DELETE')
